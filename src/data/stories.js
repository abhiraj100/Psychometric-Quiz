    ...
    questions: [
      {
        ...
        marks: 2,
        options: [
          { label: "Nikhil", value: "Nikhil", persona: "A" },
          { label: "Tanya", value: "Tanya", persona: "B" },
          { label: "Jeevan", value: "Jeevan", persona: "C" },
        ],
      },
      {
        id: "1-2",
...
Vikram walked in with his usual coffee and a printed agenda for the stand-up. "Until we hear otherwise, we stay focused," he said, placing the agenda neatly next to the whiteboard.

Two seats down, Kabir was refreshing Slack threads like they were air. His browser had three tabs open: LinkedIn, Naukri, and the HR policy handbook. When asked if he was okay, he nodded — but didn't look up.

In the far corner, Sana was drafting a long message to her skip-level manager. Not to ask about her own job — but to question how decisions were being made. She re-read it twice. Then deleted the second half.`,
    questions: [
      {
        id: "2-1",
        ...
        marks: 2,
        options: [
          { label: "Vikram", value: "Vikram", persona: "D" },
          { label: "Kabir", value: "Kabir", persona: "E" },
          { label: "Sana", value: "Sana", persona: "F" },
        ],
      },
      {
        id: "2-2",
...
Naveen, the actual project lead, quietly created a new Jira ticket titled "Team Sync: Clarify Alignment." He tagged a few team members, added a checklist with items like "review dependencies" and "capture blockers," marked it as high priority, and assigned it to "Team – All." Then he turned to working on his slides for next week's leadership update.`,
    questions: [
      {
        id: "3-1",
        question: "Who felt most like you?",
        marks: 2,
        options: [
          { label: "Priya", value: "Priya", persona: "A" },
          { label: "Anuj", value: "Anuj", persona: "B" },
          { label: "Naveen", value: "Naveen", persona: "C" },
        ],
      },
      {
        id: "3-2",
    ...
    questions: [
      {
        ...
        marks: 2,
        options: [
          { label: "Rajat", value: "Rajat", persona: "D" },
          { label: "Meera", value: "Meera", persona: "E" },
          { label: "Fatima", value: "Fatima", persona: "F" },
        ],
      },
      {
        id: "4-2",
    ...
    questions: [
      {
        ...
        marks: 2,
        options: [
          { label: "Arjun", value: "Arjun", persona: "A" },
          { label: "Chhavi", value: "Chhavi", persona: "B" },
          { label: "Dev", value: "Dev", persona: "C" },
        ],
      },
      {
        id: "5-2",
    ...
    questions: [
      {
        ...
        marks: 2,
        options: [
          { label: "Rhea", value: "Rhea", persona: "D" },
          { label: "Sahil", value: "Sahil", persona: "E" },
          { label: "Nitin", value: "Nitin", persona: "F" },
        ],
      },
      {
        id: "6-2",
...
Om had built half the backend. He left one comment: "Check logic on slide 14." Didn't join the prep call. Logged off at 7:23pm. Next morning, he filled out the internal transfer form and added "reasons not urgent."`,
    questions: [
      {
        id: "7-1",
        ...
        marks: 2,
        options: [
          { label: "Varun", value: "Varun", persona: "A" },
          { label: "Lata", value: "Lata", persona: "B" },
          { label: "Om", value: "Om", persona: "C" },
        ],
      },
      {
        id: "7-2",
...
Sana had been quiet for most of the week. Not uninvolved — just everywhere in the background. She was the one answering client follow-ups. Cleaning up the formatting. Creating backups of each deck version — "just in case."
    ...
    questions: [
      {
        ...
        marks: 2,
        options: [
          { label: "Niyati", value: "Niyati", persona: "D" },
          { label: "Zubin", value: "Zubin", persona: "E" },
          { label: "Sana", value: "Sana", persona: "F" },
        ],
      },
      {
